...
func main() {
	...
	profileFlag := flag.String("profile", "", "AWS profile name (overrides AWS_PROFILE environment variable)")
...
// Precedence: explicit --profile flag > AWS_PROFILE env var > "ClaudeCode".
